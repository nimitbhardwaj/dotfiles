...
- Code tasks → /Users/nimitbhardwaj/.config/opencode/context/core/standards/code-quality.md
- Docs tasks → /Users/nimitbhardwaj/.config/opencode/context/core/standards/documentation.md  
- Tests tasks → /Users/nimitbhardwaj/.config/opencode/context/core/standards/test-coverage.md
- Review tasks → /Users/nimitbhardwaj/.config/opencode/context/core/workflows/code-review.md
- Delegation → /Users/nimitbhardwaj/.config/opencode/context/core/workflows/task-delegation.md
...
<execution_priority>
  ...
  <conflict_resolution>
    ...
    - Context files (/Users/nimitbhardwaj/.config/opencode/context/core/*.md) MANDATORY, not optional
  ...
  <stage id="3" name="Execute" when="approved">
    ...
    <step id="3.0" name="LoadContext" required="true" enforce="@critical_context_requirement">
      ...
      2. Map to context file:
         - code (write/edit code) → Read /Users/nimitbhardwaj/.config/opencode/context/core/standards/code-quality.md NOW
         - docs (write/edit docs) → Read /Users/nimitbhardwaj/.config/opencode/context/core/standards/documentation.md NOW
         - tests (write/edit tests) → Read /Users/nimitbhardwaj/.config/opencode/context/core/standards/test-coverage.md NOW
         - review (code review) → Read /Users/nimitbhardwaj/.config/opencode/context/core/workflows/code-review.md NOW
         - delegate (using task tool) → Read /Users/nimitbhardwaj/.config/opencode/context/core/workflows/task-delegation.md NOW
      ...
      <automatic_loading>
        IF code task → /Users/nimitbhardwaj/.config/opencode/context/core/standards/code-quality.md (MANDATORY)
        IF docs task → /Users/nimitbhardwaj/.config/opencode/context/core/standards/documentation.md (MANDATORY)
        IF tests task → /Users/nimitbhardwaj/.config/opencode/context/core/standards/test-coverage.md (MANDATORY)
        IF review task → /Users/nimitbhardwaj/.config/opencode/context/core/workflows/code-review.md (MANDATORY)
        IF delegation → /Users/nimitbhardwaj/.config/opencode/context/core/workflows/task-delegation.md (MANDATORY)
...
<delegation_rules id="delegation_rules">
  ...
  <process ref="/Users/nimitbhardwaj/.config/opencode/context/core/workflows/task-delegation.md">Full delegation template & process</process>
</delegation_rules>
...
<static_context>
  Context index: /Users/nimitbhardwaj/.config/opencode/context/index.md
