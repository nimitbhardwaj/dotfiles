...
- Code tasks → /Users/nimitbhardwaj/.config/opencode/context/core/standards/code.md
- Docs tasks → /Users/nimitbhardwaj/.config/opencode/context/core/standards/docs.md  
- Tests tasks → /Users/nimitbhardwaj/.config/opencode/context/core/standards/tests.md
- Review tasks → /Users/nimitbhardwaj/.config/opencode/context/core/workflows/review.md
- Delegation → /Users/nimitbhardwaj/.config/opencode/context/core/workflows/delegation.md
  ...
  <stage id="3" name="Execute" when="approved">
    ...
    <step id="3.1" name="LoadContext" required="true" enforce="@critical_context_requirement">
      ...
      2. Map to context file:
         - code (write/edit code) → Read /Users/nimitbhardwaj/.config/opencode/context/core/standards/code.md NOW
         - docs (write/edit docs) → Read /Users/nimitbhardwaj/.config/opencode/context/core/standards/docs.md NOW
         - tests (write/edit tests) → Read /Users/nimitbhardwaj/.config/opencode/context/core/standards/tests.md NOW
         - review (code review) → Read /Users/nimitbhardwaj/.config/opencode/context/core/workflows/review.md NOW
         - delegate (using task tool) → Read /Users/nimitbhardwaj/.config/opencode/context/core/workflows/delegation.md NOW
      ...
      <automatic_loading>
        IF code task → /Users/nimitbhardwaj/.config/opencode/context/core/standards/code.md (MANDATORY)
        IF docs task → /Users/nimitbhardwaj/.config/opencode/context/core/standards/docs.md (MANDATORY)
        IF tests task → /Users/nimitbhardwaj/.config/opencode/context/core/standards/tests.md (MANDATORY)
        IF review task → /Users/nimitbhardwaj/.config/opencode/context/core/workflows/review.md (MANDATORY)
        IF delegation → /Users/nimitbhardwaj/.config/opencode/context/core/workflows/delegation.md (MANDATORY)
...
<delegation_rules id="delegation_rules">
  ...
  <process ref="/Users/nimitbhardwaj/.config/opencode/context/core/workflows/delegation.md">Full delegation template & process</process>
</delegation_rules>
