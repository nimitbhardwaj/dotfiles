...
cp -r /Users/nimitbhardwaj/.config/opencode/context ~/.opencode/
```
...
**Context-aware:** Agents automatically load patterns from `/Users/nimitbhardwaj/.config/opencode/context/` to follow your coding standards.
...
nano ~//Users/nimitbhardwaj/.config/opencode/context/project/project-context.md
...
```
"Load context from /Users/nimitbhardwaj/.config/opencode/context/ then help me create a new agent"
```
...
A: Edit `~//Users/nimitbhardwaj/.config/opencode/context/project/project-context.md` - agents automatically load this file.
